...
# Checked again here, not only before the images were built. The window between the two is
# small but real, and this is the last point where stopping still costs nothing.
"${ROOT}/scripts/check-current.sh"
