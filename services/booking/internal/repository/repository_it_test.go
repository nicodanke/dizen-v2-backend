...
import (
	...
	"github.com/nicodanke/dizen-v2-backend/services/booking/internal/db/migrations"
	"github.com/nicodanke/dizen-v2-backend/services/booking/internal/repository"
)
...
func runPackage(m *testing.M) int {
	...
	pg, terminate, err := testutils.StartPostgres(ctx, testutils.WithDatabase("booking_db"))
	if err != nil {
