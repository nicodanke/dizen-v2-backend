...
import (
	...
	"github.com/nicodanke/dizen-v2-backend/services/tours/internal/config"
)

// setRequired populates the variables the service cannot start without.
func setRequired(t *testing.T) {
	t.Helper()
	t.Setenv("SERVICE_NAME", "tours")
	t.Setenv("DATABASE_URL", "postgres://dizen:dizen@localhost:5432/tours_db?sslmode=disable")
