...
func setRequired(t *testing.T) {
	t.Helper()
	t.Setenv("SERVICE_NAME", "mail-dispatcher")
	t.Setenv("DATABASE_URL", "postgres://dizen:dizen@localhost:5432/mail_dispatcher_db?sslmode=disable")
...
func TestLoadComposesEverySubsystem(t *testing.T) {
	...
	if cfg.ServiceName != "mail-dispatcher" {
