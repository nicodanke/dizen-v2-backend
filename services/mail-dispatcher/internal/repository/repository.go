...
import (
	...
	"github.com/nicodanke/dizen-v2-backend/services/mail-dispatcher/internal/db/sqlc"
)

// Repository is the entry point to persistence for the mail-dispatcher service.
//
